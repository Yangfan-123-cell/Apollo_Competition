...
DEFINE_double(nonstatic_obstacle_nudge_l_buffer, 0.0,
...
DEFINE_double(open_space_max_forward_v, 5.0,
              "the max forward velocity for open space planning");

DEFINE_double(open_space_max_reverse_v, 5.0,
...
DEFINE_double(open_space_max_reverse_acc, 6.0,
